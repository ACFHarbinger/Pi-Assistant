...
export function HatchingExperience({ onComplete }: HatchingExperienceProps) {
  ...
  const [hatchMessages, setHatchMessages] = useState<
          ...
          setHatchMessages([
            {
              role: "assistant",
              content:
                "Hey! I'm Pi. I've just been hatched and I'm ready to help. What should we do first?",
            },
          ]);
        } finally {
          setIsLoading(false);
  ...
  const handleHatchSend = async () => {
    ...
    try {
      ...
      setHatchMessages([
        ...
        {
          role: "assistant",
          content: "Sorry, I had a bit of a glitch there. Can you repeat that?",
        },
      ]);
    } finally {
      setIsLoading(false);
  ...
  return (
    <div className="fixed inset-0 z-50 bg-gray-950 flex items-center justify-center p-6 font-sans">
      <div
        className={`transition-all duration-500 ${step === "hatching" ? "max-w-3xl" : "max-w-xl"} w-full`}
      >
        {/* Progress Indicators */}
        ...
        <div className="glass rounded-3xl p-10 bg-white/5 border border-white/10 shadow-2xl relative overflow-hidden">
          ...
          {step === "welcome" && (
            <div className="text-center space-y-6">
              ...
              {provider && (
                <div className="max-w-xs mx-auto space-y-2 animate-in fade-in slide-in-from-top-2">
                  ...
                  <p className="text-[10px] text-gray-500 italic">
                    This will be your agent's primary model.
                  </p>
                </div>
              )}
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                I'm your universal agent harness. I can code, browse, and
                control your system to help you get things done.
              </p>
              <button
                onClick={handleNext}
          ...
          {step === "model" && (
            <div className="space-y-6">
              ...
              <p className="text-sm text-gray-400">
                Choose where Pi's intelligence comes from.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-primary-500/5 rounded-2xl border border-primary-500/20 space-y-4">
                  <div className="flex items-center justify-between">
                    <h3 className="text-sm font-bold text-primary-400">
                  ...
                  {showAdvancedAuth && (
                    <div className="space-y-2 animate-in fade-in slide-in-from-top-2 duration-300">
                      <p className="text-[10px] text-gray-500 mb-2">
                        Use your own Google Cloud Client ID. Redirect URI must
                        be <code>http://localhost:5678/callback</code>.
                      </p>
                      <input
                        type="text"
                  ...
                  <button
                    onClick={async () => {
                      const clientId = showAdvancedAuth
                        ? (
                        ...
                        : null;
                      const clientSecret = showAdvancedAuth
                        ? (
                            document.getElementById(
                              "oauth-client-secret",
                            ) as HTMLInputElement
                      ...
                      if (showAdvancedAuth && (!clientId || !clientSecret)) {
                        alert(
                          "Please enter both Client ID and Secret for manual setup.",
                        );
                        return;
                      }
          ...
          {step === "skills" && (
            <div className="space-y-6">
              ...
              <p className="text-sm text-gray-400">
                What should Pi be allowed to do?
              </p>
              ...
              <div className="space-y-3">
                <SkillToggle
                  ...
                  onToggle={() =>
                    setSkills({ ...skills, shell: !skills.shell })
                  }
                />
                <SkillToggle
                  id="browser"
                  ...
                  enabled={skills.browser}
                  onToggle={() =>
                    setSkills({ ...skills, browser: !skills.browser })
                  }
                />
                <SkillToggle
                  id="files"
                  ...
                  enabled={skills.files}
                  onToggle={() =>
                    setSkills({ ...skills, files: !skills.files })
                  }
                />
              </div>
          ...
          {step === "hatching" && (
            <>
              ...
              {(hatchingPhase === "shaking" ||
                hatchingPhase === "cracking" ||
                hatchingPhase === "emerging") && (
                <div className="flex flex-col items-center justify-center h-[400px] space-y-8">
                  {/* Egg during shaking/cracking */}
                  {hatchingPhase !== "emerging" && (
                    <div
                      className={`text-8xl ${hatchingPhase === "shaking" ? "egg-shake" : "egg-crack"}`}
                    >
                      🥚
                    </div>
                  )}
                  ...
                  {hatchingPhase === "emerging" && (
                    <div className="text-8xl emerge">🤖</div>
                  )}
                ...
                <div className="space-y-6 flex flex-col h-[500px]">
                  <div className="flex items-center gap-4 mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 uppercase font-bold tracking-widest leading-tight">
...
function SkillToggle({ name, desc, enabled, onToggle }: any) {
  return (
    ...
    >
      ...
      <div
        className={`w-12 h-6 rounded-full transition-colors relative ${enabled ? "bg-primary-600" : "bg-gray-700"}`}
      >
        <div
...
function formatMessage(text: string): JSX.Element[] {
  if (!text)
    return [
      <p key="empty" className="animate-pulse">
